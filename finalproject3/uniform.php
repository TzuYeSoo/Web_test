...
<body>
  ...
  <div class="add_stock_container" id="stockin_modal">
        <div class="header_bg">
            <h2>UNIFORM</h2>
            
            <button class="close-btn" onclick="closemodal('stockin_modal')">&#10005;</button>
        </div>
        <form class="forms" method="post" action="query_insert_unif.php" enctype="multipart/form-data" id="uniformForm">

        <div class="form-grid">
           
           
            <div class="input_fields_new_unif">
                <input type="text" placeholder="Uniform name" name="unif_name" required>
                <input type="text" placeholder="Uniform quantity" name="unif_quantity" required>
                <input type="text" placeholder="Uniform program" name="unif_program" required>
            </div>
            <div class="checkboxes_grid">
                <div class="checkbox-column">
                    <label>
                        <input type="checkbox" class="item-check" data-target="polo-file" name="items[]" value="Polo"> Polo
                    </label>
                    <input type="file" id="polo-file" name="image_Polo" accept=".img, .png, .jpeg" disabled required>
...
document.getElementById("uniformForm").addEventListener("submit", function(e) {
    ...
    <div class="log_stock_container" id="modal_logs">
        <div class="header_bg">
            <h2>UNIFORM</h2>
             <button class="close-btn" onclick="closeModal('modal_logs')">&#10005;</button>
        </div>
        ...
        <div class="add_button-container">
            <input type="submit" class="add-btn1" value="ADD">
        </div>
        </form>
    </div>
                            ...
                            while($row=mysqli_fetch_assoc($result)){
                                ...
                                ?> 
                                    <tr>
                                        ...
                                        <td>
                                            <i class="fas fa-pencil-alt" onclick="editLogs()"></i>
...
function closeStockIn() {
    const modal = document.querySelector('.stockin_container');
